...
VALUES (1, '2008-09-22 16:55:07.041', 'user1', '2008-09-26 08:17:42.421', 'kanchink@mail.nih.gov', 'Kris', 'Kanchinadam', 'Kris K. is the contact person listed for this experiment. Any queries may be directed to him.', '2008-09-22', 'This is an example of a XAR file. ', 'This will contain the hypothesis of the experiment. ', 'Example 1 from CPAS', '', 'https://www.labkey.org/wiki/home/Documentation/Archive/2.1/page.view?name=tutorial2');

INSERT INTO experiment (id, creation_date, creator, modification_date, contact_email, contact_fname, contact_lname, contact_notes, date_performed, description, hypothesis, name, notes, url)
VALUES (2, '2008-09-26 10:41:25.453', 'user1', '2008-09-26 10:41:25.453', 'kk@kkmohan.com', 'Krishna', 'Kanchinadam', '', '2008-09-26', 'This is an attempt to recreate the example 3.xar.xml from CPAS website. ', 'Generated xar will be loaded into CPAS just fine..', 'Recreate Example 3 from CPAS', '', 'https://www.labkey.org/wiki/home/Documentation/Archive/2.1/page.view?name=tutorial3');

INSERT INTO experiment (id, creation_date, creator, modification_date, contact_email, contact_fname, contact_lname, contact_notes, date_performed, description, hypothesis, name, notes, url)
VALUES (3, '2008-09-26 12:17:48.562', 'user1', '2008-09-26 12:24:27.187', '', 'DB', 'User', '', '2008-09-26', 'Test pooling & fractionation protocols. Example6.xar.xml at the URL: https://www.labkey.org/wiki/home/Documentation/Archive/2.1/page.view?name=tutorial4', 'should be fine !!!!!', 'Pooling & Fractionation example from CPAS', 'Example6.xar.xml, when loaded into CPAS generated an erro. Hence creating this example from the image at URL: https://www.labkey.org/Wiki/home/Documentation/Archive/2.1/download.view?entityId=1ff5c3d1-ec6c-1029-96a3-d104f9cdad37&name=image09.gif', 'https://www.labkey.org/Wiki/home/Documentation/Archive/2.1/download.view?entityId=1ff5c3d1-ec6c-1029-96a3-d104f9cdad37&name=image09.gif');
...
VALUES (4, '2008-09-22 16:55:07.041', 'user1', '2008-09-22 16:55:07.041', '2008-09-22', 'Run', '', 1);
...
VALUES (7, '2008-09-22 16:59:15.918', 'user1', '2008-09-26 08:17:57.171', 'kanchink@mail.nih.gov', 'Kris', 'Kanchinadam', 'Kris K. is the contact person listed for this experiment. Any queries may be directed to him.', 'Describes sample handling and preparation steps.', '', 'Sample Prep Protocol', '', '');

INSERT INTO protocol (id, creation_date, creator, modification_date, contact_email, contact_fname, contact_lname, contact_notes, description, instrument, name, notes, software)
VALUES (8, '2008-09-22 17:20:40.709', 'user1', '2008-09-26 08:18:06.031', 'kanchink@mail.nih.gov', 'Kris', 'Kanchinadam', 'Kris K. is the contact person listed for this experiment. Any queries may be directed to him.', 'Describes analysis procedures and settings.', '', 'Example Analysis Protocol', '', '');

INSERT INTO protocol (id, creation_date, creator, modification_date, contact_email, contact_fname, contact_lname, contact_notes, description, instrument, name, notes, software)
VALUES (9, '2008-09-26 10:43:57.734', 'user1', '2008-09-26 10:43:57.734', 'kk@kkmohan.com', 'Krishna', 'Kanchinadam', '', 'Describes sample handling and preparation steps', '', 'Sample Prep Protocol', '', '');

INSERT INTO protocol (id, creation_date, creator, modification_date, contact_email, contact_fname, contact_lname, contact_notes, description, instrument, name, notes, software)
VALUES (10, '2008-09-26 10:45:31.609', 'user1', '2008-09-26 10:45:31.609', 'kk@kkmohan.com', 'Krishna', 'Kanchinadam', '', 'Divide the sample into 4 aliquots.', '', 'Divide Sample', '', '');

INSERT INTO protocol (id, creation_date, creator, modification_date, contact_email, contact_fname, contact_lname, contact_notes, description, instrument, name, notes, software)
VALUES (11, '2008-09-26 10:48:03.45', 'user1', '2008-09-26 10:52:10.343', 'kk@kkmohan.com', 'Krishna', 'Kanchinadam', '', 'Describes analysis procedures and settings', '', 'Example Analysis Protocol', '', '');

INSERT INTO protocol (id, creation_date, creator, modification_date, contact_email, contact_fname, contact_lname, contact_notes, description, instrument, name, notes, software)
VALUES (12, '2008-09-26 12:25:36.578', 'user1', '2008-09-26 12:25:36.578', '', 'DB', 'User', '', 'tag the sample with cy3. ', '', 'Tag with Cy3', '', '');

INSERT INTO protocol (id, creation_date, creator, modification_date, contact_email, contact_fname, contact_lname, contact_notes, description, instrument, name, notes, software)
VALUES (13, '2008-09-26 12:26:08.89', 'user1', '2008-09-26 12:26:08.89', '', 'DB', 'User', '', '', '', 'Tag with Cy5', '', '');

INSERT INTO protocol (id, creation_date, creator, modification_date, contact_email, contact_fname, contact_lname, contact_notes, description, instrument, name, notes, software)
VALUES (14, '2008-09-26 12:27:02.89', 'user1', '2008-09-26 12:27:02.89', '', 'DB', 'User', '', '', '', 'Combine tagged Sample', '', '');

INSERT INTO protocol (id, creation_date, creator, modification_date, contact_email, contact_fname, contact_lname, contact_notes, description, instrument, name, notes, software)
VALUES (15, '2008-09-26 12:29:24.718', 'user1', '2008-09-26 12:29:24.718', '', 'DB', 'User', '', 'splits the input sample. ', '', 'Ion Exchange Column', '', '');

INSERT INTO protocol (id, creation_date, creator, modification_date, contact_email, contact_fname, contact_lname, contact_notes, description, instrument, name, notes, software)
VALUES (16, '2008-09-26 12:31:43.031', 'user1', '2008-09-26 12:33:51.468', '', 'DB', 'User', '', '', '', 'Do MS2 Scan', '', '');

INSERT INTO protocol (id, creation_date, creator, modification_date, contact_email, contact_fname, contact_lname, contact_notes, description, instrument, name, notes, software)
VALUES (17, '2008-09-26 12:33:11.609', 'user1', '2008-09-26 12:35:06.14', '', 'DB', 'User', '', '', '', 'Do Conversion to mzXML', '', '');
