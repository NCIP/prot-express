    ...
    <div class="padme8">
        ...
        <div class="fadebox">
            ...
            <div class="fadebox">
                ...
                <div class="tabs">
                     <a href="<c:url value="/createExperiment/load/experimentAddNewProtocol.action" />" class="selected"><span><fmt:message key="protexpress.page.createnewexperiment.addprotocol.tabs.addnewprotocol" /></span></a>
                    <a href="<c:url value="/createExperiment/load/experimentSelectExistingProtocol.action" />"><span><fmt:message key="protexpress.page.createnewexperiment.addprotocol.tabs.selectexistingprotocol" /></span></a>
                </div>

                <jsp:include page="/WEB-INF/jsp/createexperiment/addNewProtocol.jsp" />
           </div>
        </div>
        <!--/ADD CONTENT HERE-->
    </div>
