...
import gov.nih.nci.cagrid.protexpress.common.ProtExpressGridServiceConstants;
import gov.nih.nci.cagrid.protexpress.stubs.ProtExpressGridServiceResourceProperties;
import gov.nih.nci.cagrid.protexpress.service.ProtExpressGridServiceConfiguration;
import java.io.File;
 ...
 * 
 */
public abstract class ProtExpressGridServiceResourceBase extends ReflectionResource implements Resource
                                                  {

	static final Log logger = LogFactory.getLog(ProtExpressGridServiceResourceBase.class);

	private ProtExpressGridServiceResourceConfiguration configuration;
    ...
    public ProtExpressGridServiceResourceBase() {
    }
	...
	public gov.nih.nci.cagrid.metadata.dataservice.DomainModel getDomainModel(){
		return ((ProtExpressGridServiceResourceProperties) getResourceBean()).getDomainModel();
	}
	
	public void setDomainModel(gov.nih.nci.cagrid.metadata.dataservice.DomainModel domainModel ) throws ResourceException {
        ResourceProperty prop = getResourcePropertySet().get(ProtExpressGridServiceConstants.DOMAINMODEL);
	...
	public gov.nih.nci.cagrid.metadata.ServiceMetadata getServiceMetadata(){
		return ((ProtExpressGridServiceResourceProperties) getResourceBean()).getServiceMetadata();
	}
	
	public void setServiceMetadata(gov.nih.nci.cagrid.metadata.ServiceMetadata serviceMetadata ) throws ResourceException {
        ResourceProperty prop = getResourcePropertySet().get(ProtExpressGridServiceConstants.SERVICEMETADATA);
	...
	private void loadDomainModelFromFile() {
      if(getDomainModel()==null){
		try {
			...
			((ProtExpressGridServiceResourceProperties) this.getResourceBean()).setDomainModel((gov.nih.nci.cagrid.metadata.dataservice.DomainModel) Utils.deserializeDocument(dataFile.getAbsolutePath(),
	...
	private void loadServiceMetadataFromFile() {
      if(getServiceMetadata()==null){
		try {
			...
			((ProtExpressGridServiceResourceProperties) this.getResourceBean()).setServiceMetadata((gov.nih.nci.cagrid.metadata.ServiceMetadata) Utils.deserializeDocument(dataFile.getAbsolutePath(),
