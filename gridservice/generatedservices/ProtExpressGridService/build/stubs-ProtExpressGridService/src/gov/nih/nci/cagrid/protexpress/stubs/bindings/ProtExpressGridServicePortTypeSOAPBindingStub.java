/**
 * ProtExpressGridServicePortTypeSOAPBindingStub.java
 *
 * This file was auto-generated from WSDL
 * by the Apache Axis 1.2RC2 Apr 28, 2006 (12:42:00 EDT) WSDL2Java emitter.
 */

package gov.nih.nci.cagrid.protexpress.stubs.bindings;

public class ProtExpressGridServicePortTypeSOAPBindingStub extends org.apache.axis.client.Stub implements gov.nih.nci.cagrid.protexpress.stubs.ProtExpressGridServicePortType {
    ...
    public ProtExpressGridServicePortTypeSOAPBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public ProtExpressGridServicePortTypeSOAPBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public ProtExpressGridServicePortTypeSOAPBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
    ...
    private void addBindings0() {
            ...
            qName = new javax.xml.namespace.QName("http://protexpress.cagrid.nci.nih.gov/ProtExpressGridService/CQLResultTypes", "PermissibleCQLObjectResults");
            cachedSerQNames.add(qName);
            cls = gov.nih.nci.cagrid.protexpress.cqlresulttypes.PermissibleCQLObjectResults.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            qName = new javax.xml.namespace.QName("http://protexpress.cagrid.nci.nih.gov/ProtExpressGridService", ">ProtExpressGridServiceResourceProperties");
            cachedSerQNames.add(qName);
            cls = gov.nih.nci.cagrid.protexpress.stubs.ProtExpressGridServiceResourceProperties.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
    ...
    private void addBindings1() {
            ...
            qName = new javax.xml.namespace.QName("http://protexpress.cagrid.nci.nih.gov/ProtExpressGridService/types", ">ProtExpressGridServiceReference");
            cachedSerQNames.add(qName);
            cls = gov.nih.nci.cagrid.protexpress.stubs.types.ProtExpressGridServiceReference.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
