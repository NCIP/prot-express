...
public class TestClient
{
	...
	public void testSearch() throws Exception
	{
		...
		String url = "http://localhost:8080/protExpressGridApp/services/protExpressGridAppService";
		...
		for(Class klass:classList)
		{
			try 
			{
				...
				call.setOperationName(new QName("protExpressGridAppService", "queryObject"));
	...
	private void testGetAssociation(String url, Service service, Object containingObj, Class associationClass, String rolename) throws Exception {
		...
		call.setTargetEndpointAddress(new java.net.URL(url));
		call.setOperationName(new QName("protExpressGridAppService", "getAssociation"));
