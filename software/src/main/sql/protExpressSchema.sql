...
drop table IF EXISTS audit_info CASCADE;
...
create table audit_info (id int8 not null, creation_date timestamp not null, creator varchar(100) not null, modification_date timestamp not null, primary key (id));
...
create table experiment (id int8 not null, date_performed date not null, description varchar(2000), hypothesis varchar(500), name varchar(200) not null, notes varchar(2000), url varchar(200), audit_info_id int8, contact_person_id int8, primary key (id));
create table experiment_run (id int8 not null, date_performed date not null, name varchar(50) not null, notes varchar(2000), audit_info_id int8, experiment_id int8 not null, primary key (id));
...
create table protocol (id int8 not null, description varchar(2000), instrument varchar(200), name varchar(200) not null, notes varchar(2000), software varchar(200), audit_info_id int8, contact_person_id int8, primary key (id));
create table protocol_application (id int8 not null, comments varchar(2000), date_performed date not null, notes varchar(2000), audit_info_id int8, experiment_run_id int8 not null, protocol_id int8 not null, primary key (id));
...
alter table experiment add constraint FKFAE9DBFD680A9614 foreign key (audit_info_id) references audit_info;
alter table experiment_run add constraint FK7A9E7F49AF0AC241 foreign key (experiment_id) references experiment;
alter table experiment_run add constraint FK7A9E7F49680A9614 foreign key (audit_info_id) references audit_info;
...
alter table protocol add constraint FKC50A8E98680A9614 foreign key (audit_info_id) references audit_info;
...
alter table protocol_application add constraint FK901CE29680A9614 foreign key (audit_info_id) references audit_info;
