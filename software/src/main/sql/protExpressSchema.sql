...
create table protapp_outputs (protapp_id int8 not null, output_id int8 not null, unique (output_id));
...
create table protocol_application (id int8 not null, activity_date date not null, creation_date timestamp not null, creator varchar(100) not null, modification_date timestamp not null, comments varchar(2000), name varchar(200) not null, notes varchar(2000), step_number int8 not null, experiment_run_id int8 not null, protocol_id int8 not null, primary key (id));
