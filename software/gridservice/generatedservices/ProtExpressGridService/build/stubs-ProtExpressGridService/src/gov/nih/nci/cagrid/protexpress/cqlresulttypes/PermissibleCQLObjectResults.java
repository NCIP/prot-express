...
public class PermissibleCQLObjectResults  implements java.io.Serializable {
    ...
    private gov.nih.nci.protexpress.domain.audit.AuditInfo auditInfo;
    ...
    public PermissibleCQLObjectResults(
           gov.nih.nci.protexpress.domain.audit.AuditInfo auditInfo,
    ...
    /**
     * Gets the auditInfo value for this PermissibleCQLObjectResults.
     * 
     * @return auditInfo
     */
    public gov.nih.nci.protexpress.domain.audit.AuditInfo getAuditInfo() {
        return auditInfo;
    }


    /**
     * Sets the auditInfo value for this PermissibleCQLObjectResults.
     * 
     * @param auditInfo
     */
    public void setAuditInfo(gov.nih.nci.protexpress.domain.audit.AuditInfo auditInfo) {
        this.auditInfo = auditInfo;
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        _equals = true && 
            ...
            ((this.auditInfo==null && other.getAuditInfo()==null) || 
             (this.auditInfo!=null &&
              this.auditInfo.equals(other.getAuditInfo()))) &&
    ...
    public synchronized int hashCode() {
        ...
        if (getAuditInfo() != null) {
            _hashCode += getAuditInfo().hashCode();
        }
        if (getProtocol() != null) {
    ...
    static {
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("gme://caCORE.caCORE/3.2/gov.nih.nci.protexpress.domain.audit", "AuditInfo"));
        elemField.setXmlType(new javax.xml.namespace.QName("gme://caCORE.caCORE/3.2/gov.nih.nci.protexpress.domain.audit", "AuditInfo"));
        elemField.setMinOccurs(0);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
