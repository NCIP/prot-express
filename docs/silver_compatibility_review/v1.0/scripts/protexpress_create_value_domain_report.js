...
var csvFilePath = "C:\\ncicb_svn\\gpsxar\\trunk\\docs\\silver_compatibility_review\\v1.0\\artifacts\\protexpress_value_domain_report.csv";
...
generateValueDomainReport();

function generateValueDomainReport() {
    fso = new ActiveXObject("Scripting.FileSystemObject");
    outputFile = fso.CreateTextFile(csvFilePath, true);
